...
const statisticsPage = (props: Props) => {
  return (
    <div className="min-h-screen">
      <div className="flex border-8 border-mind-blue h-24 items-center justify-center text-xl sm:text-3xl text-mind-blue font-bold font-markazi ">
      ...
      <div className="flex justify-center">
        <div className="grid md:grid-cols-3 gap-x-10">
          ...
          <div className="flex flex-col h-[400px] justify-center items-center pb-32">
      ...
      <div className="h-24 w-full bg-mind-blue flex justify-center items-center">
        <div className="h-[50%] px-4 border-4 border-white font-khula text-white text-base sm:text-lg md:text-2xl flex font-bold justify-center items-center">
